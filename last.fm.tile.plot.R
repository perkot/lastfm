...
#bind 2017 and 2018
last.fm.df <- rbind(last.fm.df.2016, last.fm.df.2017, last.fm.df.2018, last.fm.df.2019)
...
#Need to remove duplicate song/artist combos in succession
...
# extract day of month as x axis ... 1 to 31
# running down y axis is year-month
# create grid, 31 x 60
...
last.fm.calendar %>% 
  ...
  labs(x = "",
       y = "",
       title = "5 years of song-plays",
       subtitle = "Daily number of song plays on itunes between 2016 & 2019",
  ...
  # Really useful to specify our own values for y-axis
  scale_y_discrete(
